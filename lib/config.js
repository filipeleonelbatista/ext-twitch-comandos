...
/** URL for channel settings: /api/channel-settings when same origin, else {apiBase}/api/channel-settings */
export function getChannelSettingsUrl() {
  const base = getApiBaseUrl();
  return base ? `${base}/api/channel-settings` : '/api/channel-settings';
}
